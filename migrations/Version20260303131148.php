 ...
 */
final class Version20260303131148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat_sponsor (id INT AUTO_INCREMENT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, montant DOUBLE PRECISION NOT NULL, description LONGTEXT DEFAULT NULL, statut VARCHAR(50) DEFAULT NULL, notified TINYINT NOT NULL, statut_paiement VARCHAR(50) NOT NULL, sponsor_id INT NOT NULL, equipe_id INT NOT NULL, INDEX IDX_28429AA212F7FB51 (sponsor_id), INDEX IDX_28429AA26D861B89 (equipe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, coach VARCHAR(100) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE joueur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, date_naissance DATE NOT NULL, numero INT NOT NULL, image VARCHAR(255) DEFAULT NULL, equipe_id INT NOT NULL, INDEX IDX_FD71A9C56D861B89 (equipe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE match_lineup (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, buts INT DEFAULT NULL, cartons_jaunes INT DEFAULT NULL, cartons_rouges INT DEFAULT NULL, position_x DOUBLE PRECISION DEFAULT NULL, position_y DOUBLE PRECISION DEFAULT NULL, matchs_id INT NOT NULL, joueur_id INT NOT NULL, INDEX IDX_6C11F7CB88EB7468 (matchs_id), INDEX IDX_6C11F7CBA9E2D76C (joueur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE matchs (id INT AUTO_INCREMENT NOT NULL, id_match VARCHAR(100) NOT NULL, date_match DATE NOT NULL, heure_debut TIME NOT NULL, lieu VARCHAR(100) NOT NULL, type VARCHAR(50) NOT NULL, statut VARCHAR(50) NOT NULL, lineup_domicile LONGTEXT DEFAULT NULL, lineup_exterieur LONGTEXT DEFAULT NULL, score_equipe_domicile INT DEFAULT NULL, score_equipe_exterieur INT DEFAULT NULL, equipe_domicile_id INT NOT NULL, equipe_exterieur_id INT NOT NULL, INDEX IDX_6B1E60415FE1AEAD (equipe_domicile_id), INDEX IDX_6B1E604121ECD755 (equipe_exterieur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, message VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_read TINYINT NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, quantity INT DEFAULT NULL, order_date DATE NOT NULL, status VARCHAR(20) NOT NULL, payment_method VARCHAR(20) DEFAULT NULL, payment_status VARCHAR(20) DEFAULT NULL, size VARCHAR(10) DEFAULT NULL, contact_email VARCHAR(180) DEFAULT NULL, contact_phone VARCHAR(30) DEFAULT NULL, shipping_address LONGTEXT DEFAULT NULL, billing_address LONGTEXT DEFAULT NULL, total_amount NUMERIC(12, 2) DEFAULT NULL, product_id INT DEFAULT NULL, entraineur_id INT DEFAULT NULL, INDEX IDX_F52993984584665A (product_id), INDEX IDX_F5299398F8478A1 (entraineur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, unit_price NUMERIC(10, 2) NOT NULL, product_id INT NOT NULL, order_ref_id INT NOT NULL, INDEX IDX_52EA1F094584665A (product_id), INDEX IDX_52EA1F09E238517C (order_ref_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, category VARCHAR(255) DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, stock INT NOT NULL, size VARCHAR(10) DEFAULT NULL, brand VARCHAR(30) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE sponsor (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, budget DOUBLE PRECISION NOT NULL, logo_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQUE_sponsor_nom (nom), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE match_lineup ADD CONSTRAINT FK_6C11F7CB88EB7468 FOREIGN KEY (matchs_id) REFERENCES matchs (id)');
        $this->addSql('ALTER TABLE match_lineup ADD CONSTRAINT FK_6C11F7CBA9E2D76C FOREIGN KEY (joueur_id) REFERENCES joueur (id)');
